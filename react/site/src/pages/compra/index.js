        ...
        <div className="container-compra">
            ...
            <div className="compra1-box1">
                <div className="img-compra">
                    <div className="imagemC-box1"> <img src="../../assets/images/brigadeiro_de_churros.svg" alt="" /> </div>
                </div>
            
                <div className="descricaoC-box1">
                    <div className="desc-titulo1">Descrição</div> 
                    <div className="desc-descricao1">Que tal um brigadeiro com sabor diferenciado? Esse é nossa nova sensação, brigadeiro sabor churros!!</div>
                </div>

                <div className="estrelinhas-compra1">
                    <div className="img-estrelinha">
                        <img src="../../assets/images/estrelinhas/Star 3.svg" alt="" />
                        <img src="../..//assets/images/estrelinhas/Star 3.svg" alt="" />
                        <img src="../../assets/images/estrelinhas/Star 3.svg" alt="" />
                        <img src="../../assets/images/estrelinhas/Star 3.svg" alt="" />
                        <img src="../../assets/images/estrelinhas/Star 3.svg" alt="" />
                ...
                <div className="botoesC-1">
                    <div className="botoes-box1">
                        ...
                        <div className="botoes-box2">
                            <button className="Add-favoritos-bt"> <img src="../../assets/images/coracao.png"  alt="" /> Add aos Favoritos</button>
                                <button className="Confirm-compra1"> Confirmar Compra</button>
                        </div>
